...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Jeff K',", type: 'array-item' },
    { code: "    role: 'Full Stack Developer',", type: 'array-item' },
    { code: "    bio: 'Creating innovative web solutions'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Jeff <span className={styles.accentText}>K</span>
          </h1>
          ...
          <p className={styles.bio}>
            ...
            Creating innovative web applications with modern technologies.
          </p>
